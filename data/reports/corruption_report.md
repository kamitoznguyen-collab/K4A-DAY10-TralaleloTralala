...
> **Report Timestamp:** `2026-09-25T10:22:22.744763+00:00`  
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Retrieval Hit Rate** | **100.0%** | **80.0%** | **100.0%** | `-20.0%` | 🟢 Fully Restored (100%) |
...
| **Stale Ratio (>180d)** | **<= 25.0%** | **27.3%** | **4.2%** | Spike in Stale Papers | 🟢 Normalized |
| **Active Record Count** | **24 rows** | **22 rows** | **24 rows** | Record Count Variance | 🟢 24 Rows Exact |
...
- Metrics in Repaired state match Baseline state across all decimal places (`Retrieval Hit Rate = 100.0%`, `Mean Token F1 = 1.0000`).
